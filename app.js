...
var createNewTaskElement=function(taskString){
    ...
    label.classList.add("task-list__task-label");

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.classList.add("task-list__task-checkbox");
    editInput.type="text";
    editInput.classList.add("task-list__task-input");
    ...
    deleteButtonImg.classList.add("button-image_delete");
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("task-list__task-item_edit-mode");
    ...
    listItem.classList.toggle("task-list__task-item_edit-mode");
};
...
//select ListItems children
    var checkBox=taskListItem.querySelector(".task-list__task-checkbox");
